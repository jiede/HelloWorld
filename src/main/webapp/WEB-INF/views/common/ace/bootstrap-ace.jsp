...
<!--[if lte IE 8]>
<script src="${contextPath}/res/plugIn/ace/assets/js/excanvas.min.js"></script>
<![endif]-->
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery-ui.custom.min.js"></script>
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery.ui.touch-punch.min.js"></script>
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery.easypiechart.min.js"></script>
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery.sparkline.index.min.js"></script>
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery.flot.min.js"></script>
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery.flot.pie.min.js"></script>
<script src="${contextPath}/res/plugIn/ace/assets/js/jquery.flot.resize.min.js"></script>
...
<!-- ace settings handler -->
<script src="${contextPath}/res/plugIn/assets/js/ace-extra.min.js"></script>

<!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

<!--[if lte IE 8]>
<script src="${contextPath}/res/plugIn/assets/js/html5shiv.min.js"></script>
<script src="${contextPath}/res/plugIn/assets/js/respond.min.js"></script>
<![endif]-->
