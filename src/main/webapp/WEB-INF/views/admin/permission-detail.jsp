        ...
        <div class="main-content-inner">
            ...
            <div class="page-content" id="tabAll">
                <div class="row">
                    ...
                    <h3 class="header smaller lighter blue">更新权限</h3>
                    <form class="form-horizontal" method="post" id="updateForm" role="form" action="">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click">
                                        <input type="text" id="permissionCode" name="permissionCode"  value="${dto.permissionCode}" class="col-xs-2"/></span>
                                    （权限唯一标识）
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click"><select style="width:200px;" class="chosen-select form-control" name="permissionType" id="permissionType">
                                        <option value="1" <c:if test="${dto.permissionType == 1}"> selected="selected" </c:if> >菜单</option>
                                        <option value="2" <c:if test="${dto.permissionType == 2}"> selected="selected" </c:if> >链接</option>
                                    </select></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click">
                                        <input type="text" id="permissionName" name="permissionName" value="${dto.permissionName}" class="col-xs-2"/></span>
                                    （目录树节点名称）
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click">
                                        <input type="text" id="permissionValue" name="permissionValue" value="${dto.permissionValue}" class="col-xs-2"/></span>
                                    （请求URL，第三级菜单及链接需填）
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click">
                                        <input type="text" id="permissionLevel" name="permissionLevel" value="${dto.permissionLevel}" class="col-xs-2"/></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">&nbsp;
                                    ...
                                    <span class="editable editable-click">
                                        <input type="hidden" name="parentId" value="${dto.parentId}" id="parentId"/>
                                        <input type="text" id="parentCode" readonly value="${dto.parentName}" class="col-xs-2"/></span>
                                    （一级菜单可不填）
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable editable-click">
                                        <input type="text" id="icon" name="icon"  value="${dto.icon}" class="col-xs-2"/></span>
                                    （仅供一级菜单显示使用）
                                </div>
                            </div>
                            <div class="profile-info-row">
