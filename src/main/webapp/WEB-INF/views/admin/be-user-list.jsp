        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-2" >
                            <input id="userName" type="text"  placeholder="用户名" class="col-xs-3 col-sm-12" />
                        </div>
                        <div class="col-sm-1" >
...
<script type="text/javascript">
    $(function(){
        $("#grid-table").jqGrid({
            ...
            autowidth:true,//自动宽
            colNames:['id','用户名', '角色列表','操作'],
            colModel:[
                {name:'id',index:'id',sortable:false,hidden:true},
                {name:'userName',index:'userName',sortable:false,width:10},
                {name:'roleNames',index:'roleNames',sortable:false,width:20},
                {name:'status',index:'status',sortable:false,width:10,formatter:function(cellvalue, options, rowObject){
                    var html = '<div class="hidden-sm hidden-xs btn-group">';

                    html = html + '<button class="btn btn-xs btn-danger" data-id ="' + rowObject.id + '" data-username ="' + rowObject.userName + '">';
